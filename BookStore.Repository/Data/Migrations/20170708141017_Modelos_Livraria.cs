...
{
    public partial class Modelos_Livraria : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Corredor = table.Column<int>(nullable: false),
                    DataLancado = table.Column<DateTime>(nullable: false),
                    GeneroId = table.Column<int>(nullable: true),
                    Nome = table.Column<string>(nullable: true),
                    NumeroPaginas = table.Column<int>(nullable: false),
                    Prateleira = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
